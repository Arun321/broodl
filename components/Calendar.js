...
export default function Calendar(props) {
  ...
  console.log("This month data", completeData?.[selectedYear]?.[numericMonth]);
  ...
  const monthNow = new Date(
    selectedYear,
    Object.keys(selectedMonth).indexOf(selectedMonth),
    1
  );
              ...
              {dayList.map((dayOfWeek, dayOfWeekIndex) => {
                ...
                return (
                  <div
                    ...
                    className={
                      "text-sm sm:text-sm border border-solid p-2 items-center gap-2 justify-between rounded-lg " +
